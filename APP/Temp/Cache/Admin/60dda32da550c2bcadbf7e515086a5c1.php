    ...
    <div id="content" class="col-mod">
			<div class="panel panel-archon">
				...
				<div class="panel-body">
					<form action="<?php echo U('Cate/Catesort');?>" method="post">
                    ...
                    <thead>
						...
						<?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr level="<?php echo ($vo['level']); ?>">
                         <td ><input type="checkbox" id="inlineCheckbox2" value="option2"></td>
                         <td ><?php echo ($vo['id']); echo ($vo['pid']); ?></td>
							<td>
							<div class="col-lg-4">
								<input type="text" class="form-control" placeholder="排序" name="<?php echo ($vo['id']); ?>" id="ruleTitle" value="<?php echo ($vo['sort']); ?>"/>
							</div>
                        </td>
							<td>
<a href="" class="zd">[-]</a>
<div  class="rows">
<div class="jibie"><?php echo ($vo['html']); ?></div>
								 <div class="col-lg-5 c_l">
													<input type="text" class="form-control" placeholder="" value="<?php echo ($vo['name']); ?>">
												</div>
                                                </div>
                           </td>
							...
							<td>
								<div class="btn-group btn-group-xs">
									<a href="<?php echo U('Cate/addCate',array('pid'=>$vo['id']));?>" class="btn btn-sm btn-info mhm">添加子栏目</a>
									<a href="<?php echo U('Cate/edit',array('id'=>$vo['id'],'pid'=>$vo['pid']));?>" class="btn btn-warning">修改</a>
									<a href="<?php echo U('Cate/delCate',array('id'=>$vo['id']));?>" class="btn btn-danger">删除</a>
								</div>
