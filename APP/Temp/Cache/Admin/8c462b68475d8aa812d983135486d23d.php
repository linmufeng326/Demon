			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<table class="table table-hover table-bordered table-condensed">
						...
						<?php if(is_array($blog)): $i = 0; $__LIST__ = $blog;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                        	<?php if(ACTION_NAME == "index"): ?><div class="btn-group btn-group-xs">
									<a href="<?php echo U('blog/edit',array('id'=>$vo['id']));?>" class="btn btn-warning">修改</a>
									<a href="<?php echo U('blog/trach',array('id'=>$vo['id'],'type' => 1));?>" class="btn btn-danger">删除</a>
								</div>
								<?php else: ?>
								<div class="btn-group btn-group-xs">
									<a href="<?php echo U('blog/trach',array('id'=>$vo['id'],'type' => 0));?>" class="btn btn-warning">还原</a>
									<a href="<?php echo U('blog/tracher',array('id'=>$vo['id']));?>" class="btn btn-danger">彻底删除</a>
								</div><?php endif; ?>
							</td>
